...
func TestTranslateCreateTable(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			input: "CREATE TABLE pk (id INT NOT NULL PRIMARY KEY, name VARCHAR(50))",
			expected: "CREATE TABLE pk (id INT4 NOT NULL PRIMARY KEY, " +
				"name VARCHAR(50) NULL)",
		},
		{
			name:  "identity with primary key",
			input: "CREATE TABLE ipk (id INT IDENTITY(1,1) NOT NULL PRIMARY KEY, data VARCHAR(50))",
			expected: "CREATE TABLE ipk (id INT4 GENERATED BY DEFAULT AS IDENTITY NOT NULL PRIMARY KEY, " +
