...
type VectorizedStats struct {
	...
	// num_input_tuples is the number of tuples that the input to the operator
	// that this stats collector is wrapping sent us.
	NumInputTuples int64 `protobuf:"varint,8,opt,name=num_input_tuples,json=numInputTuples,proto3" json:"num_input_tuples,omitempty"`
}
...
func (*VectorizedStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_stats_952bb8bf2e96215a, []int{0}
}
...
func init() {
	proto.RegisterFile("sql/colexec/execpb/stats.proto", fileDescriptor_stats_952bb8bf2e96215a)
}

var fileDescriptor_stats_952bb8bf2e96215a = []byte{
	// 371 bytes of a gzipped FileDescriptorProto
	,
}
