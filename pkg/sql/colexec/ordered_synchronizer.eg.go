...
func setBool(o *OrderedSynchronizer, vec coldata.Vec, colIdx int, srcRowIdx, outputIdx int) {
	srcCol := vec.Bool()
	outCol := o.outBoolCols[o.outputInfo[colIdx].outColIdx]
...
func setBytes(o *OrderedSynchronizer, vec coldata.Vec, colIdx int, srcRowIdx, outputIdx int) {
	srcCol := vec.Bytes()
	outCol := o.outBytesCols[o.outputInfo[colIdx].outColIdx]
	v := srcCol.Get(srcRowIdx) //gcassert:inline
...
func setDecimal(o *OrderedSynchronizer, vec coldata.Vec, colIdx int, srcRowIdx, outputIdx int) {
	srcCol := vec.Decimal()
	outCol := o.outDecimalCols[o.outputInfo[colIdx].outColIdx]
	v := srcCol.Get(srcRowIdx) //gcassert:inline
...
func setInt16(o *OrderedSynchronizer, vec coldata.Vec, colIdx int, srcRowIdx, outputIdx int) {
	srcCol := vec.Int16()
	outCol := o.outInt16Cols[o.outputInfo[colIdx].outColIdx]
	v := srcCol.Get(srcRowIdx) //gcassert:inline
	outCol[outputIdx] = v
}
...
func setInt32(o *OrderedSynchronizer, vec coldata.Vec, colIdx int, srcRowIdx, outputIdx int) {
	srcCol := vec.Int32()
	outCol := o.outInt32Cols[o.outputInfo[colIdx].outColIdx]
	v := srcCol.Get(srcRowIdx) //gcassert:inline
	outCol[outputIdx] = v
}
...
func setInt64(o *OrderedSynchronizer, vec coldata.Vec, colIdx int, srcRowIdx, outputIdx int) {
	srcCol := vec.Int64()
	outCol := o.outInt64Cols[o.outputInfo[colIdx].outColIdx]
	v := srcCol.Get(srcRowIdx) //gcassert:inline
	outCol[outputIdx] = v
}
...
func setFloat64(o *OrderedSynchronizer, vec coldata.Vec, colIdx int, srcRowIdx, outputIdx int) {
	srcCol := vec.Float64()
	outCol := o.outFloat64Cols[o.outputInfo[colIdx].outColIdx]
	v := srcCol.Get(srcRowIdx) //gcassert:inline
	outCol[outputIdx] = v
}
...
func setTimestamp(o *OrderedSynchronizer, vec coldata.Vec, colIdx int, srcRowIdx, outputIdx int) {
	...
	outCol := o.outTimestampCols[o.outputInfo[colIdx].outColIdx]
	v := srcCol.Get(srcRowIdx) //gcassert:inline
	outCol[outputIdx] = v
}
...
func setInterval(o *OrderedSynchronizer, vec coldata.Vec, colIdx int, srcRowIdx, outputIdx int) {
	srcCol := vec.Interval()
	outCol := o.outIntervalCols[o.outputInfo[colIdx].outColIdx]
	v := srcCol.Get(srcRowIdx) //gcassert:inline
	outCol[outputIdx] = v
}
...
func setDatum(o *OrderedSynchronizer, vec coldata.Vec, colIdx int, srcRowIdx, outputIdx int) {
	srcCol := vec.Datum()
	outCol := o.outDatumCols[o.outputInfo[colIdx].outColIdx]
...
func (o *OrderedSynchronizer) Init() {
	...
	for i, outVec := range o.output.ColVecs() {
		...
		case types.BoolFamily:
			...
			case -1:
			default:
				o.outputInfo[i].outColIdx = len(o.outBoolCols)
				o.outBoolCols = append(o.outBoolCols, outVec.Bool())
				o.outputInfo[i].setter = setBool
			}
		case types.BytesFamily:
			switch o.typs[i].Width() {
			case -1:
			default:
				o.outputInfo[i].outColIdx = len(o.outBytesCols)
				o.outBytesCols = append(o.outBytesCols, outVec.Bytes())
				o.outputInfo[i].setter = setBytes
			}
		case types.DecimalFamily:
			switch o.typs[i].Width() {
			case -1:
			default:
				o.outputInfo[i].outColIdx = len(o.outDecimalCols)
				o.outDecimalCols = append(o.outDecimalCols, outVec.Decimal())
				o.outputInfo[i].setter = setDecimal
			}
		case types.IntFamily:
			switch o.typs[i].Width() {
			case 16:
				o.outputInfo[i].outColIdx = len(o.outInt16Cols)
				o.outInt16Cols = append(o.outInt16Cols, outVec.Int16())
				o.outputInfo[i].setter = setInt16
			case 32:
				o.outputInfo[i].outColIdx = len(o.outInt32Cols)
				o.outInt32Cols = append(o.outInt32Cols, outVec.Int32())
				o.outputInfo[i].setter = setInt32
			case -1:
			default:
				o.outputInfo[i].outColIdx = len(o.outInt64Cols)
				o.outInt64Cols = append(o.outInt64Cols, outVec.Int64())
				o.outputInfo[i].setter = setInt64
			}
		case types.FloatFamily:
			switch o.typs[i].Width() {
			case -1:
			default:
				o.outputInfo[i].outColIdx = len(o.outFloat64Cols)
				o.outFloat64Cols = append(o.outFloat64Cols, outVec.Float64())
				o.outputInfo[i].setter = setFloat64
			}
		case types.TimestampTZFamily:
			switch o.typs[i].Width() {
			case -1:
			default:
				o.outputInfo[i].outColIdx = len(o.outTimestampCols)
				o.outTimestampCols = append(o.outTimestampCols, outVec.Timestamp())
				o.outputInfo[i].setter = setTimestamp
			}
		case types.IntervalFamily:
			switch o.typs[i].Width() {
			case -1:
			default:
				o.outputInfo[i].outColIdx = len(o.outIntervalCols)
				o.outIntervalCols = append(o.outIntervalCols, outVec.Interval())
				o.outputInfo[i].setter = setInterval
			}
		case typeconv.DatumVecCanonicalTypeFamily:
			switch o.typs[i].Width() {
			case -1:
			default:
				o.outputInfo[i].outColIdx = len(o.outDatumCols)
				o.outDatumCols = append(o.outDatumCols, outVec.Datum())
				o.outputInfo[i].setter = setDatum
			}
		default:
