...
// Release releases this tableReader back to the pool, retaining slice capacity
// of internal fields when applicable. The tableReader may not be used again
