...
type ProcessorCoreUnion struct {
	...
	PropValidator           *PropValidatorSpec           `protobuf:"bytes,27,opt,name=propValidator" json:"propValidator,omitempty"`
}
...
type Props struct {
	NotNullCols []int64 `protobuf:"varint,1,rep,name=not_null_cols,json=notNullCols" json:"not_null_cols,omitempty"`
}

func (m *Props) Reset()                    { *m = Props{} }
func (m *Props) String() string            { return proto.CompactTextString(m) }
func (*Props) ProtoMessage()               {}
func (*Props) Descriptor() ([]byte, []int) { return fileDescriptorProcessors, []int{32} }

type PropValidatorSpec struct {
	Props *Props `protobuf:"bytes,1,opt,name=props" json:"props,omitempty"`
}

func (m *PropValidatorSpec) Reset()                    { *m = PropValidatorSpec{} }
func (m *PropValidatorSpec) String() string            { return proto.CompactTextString(m) }
func (*PropValidatorSpec) ProtoMessage()               {}
func (*PropValidatorSpec) Descriptor() ([]byte, []int) { return fileDescriptorProcessors, []int{33} }
...
func init() {
	...
	proto.RegisterType((*Props)(nil), "cockroach.sql.distsqlrun.Props")
	proto.RegisterType((*PropValidatorSpec)(nil), "cockroach.sql.distsqlrun.PropValidatorSpec")
...
func (m *ProcessorCoreUnion) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PropValidator != nil {
		dAtA[i] = 0xda
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintProcessors(dAtA, i, uint64(m.PropValidator.Size()))
		n30, err := m.PropValidator.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n30
...
func (m *JoinReaderSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.LookupColumns) > 0 {
		dAtA35 := make([]byte, len(m.LookupColumns)*10)
		var j34 int
	...
	n36, err := m.OnExpr.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n36
	...
	n37, err := m.IndexFilterExpr.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n37
...
func (m *SorterSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	n38, err := m.OutputOrdering.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n38
...
func (m *ZigzagJoinerSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.IndexIds) > 0 {
		dAtA40 := make([]byte, len(m.IndexIds)*10)
		var j39 int
		...
		dAtA[i] = 0x1a
		i++
		i = encodeVarintProcessors(dAtA, i, uint64(j39))
		i += copy(dAtA[i:], dAtA40[:j39])
	}
	dAtA[i] = 0x22
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.OnExpr.Size()))
	n41, err := m.OnExpr.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n41
...
func (m *Columns) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.Columns) > 0 {
		dAtA43 := make([]byte, len(m.Columns)*10)
		var j42 int
		...
		dAtA[i] = 0xa
		i++
		i = encodeVarintProcessors(dAtA, i, uint64(j42))
...
func (m *MergeJoinerSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	n44, err := m.LeftOrdering.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n44
	...
	n45, err := m.RightOrdering.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n45
...
func (m *HashJoinerSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.LeftEqColumns) > 0 {
		dAtA48 := make([]byte, len(m.LeftEqColumns)*10)
		var j47 int
		...
		dAtA[i] = 0xa
		i++
		i = encodeVarintProcessors(dAtA, i, uint64(j47))
		i += copy(dAtA[i:], dAtA48[:j47])
	}
	if len(m.RightEqColumns) > 0 {
		dAtA50 := make([]byte, len(m.RightEqColumns)*10)
		var j49 int
		...
		dAtA[i] = 0x12
		i++
		i = encodeVarintProcessors(dAtA, i, uint64(j49))
		i += copy(dAtA[i:], dAtA50[:j49])
	}
	dAtA[i] = 0x2a
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.OnExpr.Size()))
	n51, err := m.OnExpr.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n51
...
func (m *AggregatorSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.GroupCols) > 0 {
		dAtA53 := make([]byte, len(m.GroupCols)*10)
		var j52 int
		...
		dAtA[i] = 0x12
		i++
		i = encodeVarintProcessors(dAtA, i, uint64(j52))
	...
	if len(m.OrderedGroupCols) > 0 {
		dAtA55 := make([]byte, len(m.OrderedGroupCols)*10)
		var j54 int
		...
		dAtA[i] = 0x22
		i++
		i = encodeVarintProcessors(dAtA, i, uint64(j54))
...
func (m *BackfillerSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.Table.Size()))
	n56, err := m.Table.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n56
	...
	n57, err := m.ReadAsOf.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n57
...
func (m *FlowSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	n58, err := m.FlowID.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n58
...
func (m *ReadImportDataSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	n60, err := m.Format.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n60
...
func (m *Props) MarshalTo(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.NotNullCols) > 0 {
		for _, num := range m.NotNullCols {
			dAtA[i] = 0x8
			i++
			i = encodeVarintProcessors(dAtA, i, uint64(num))
		}
...
func (m *PropValidatorSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *PropValidatorSpec) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.Props != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintProcessors(dAtA, i, uint64(m.Props.Size()))
		n79, err := m.Props.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n79
...
func (m *PropValidatorSpec) Size() (n int) {
	var l int
	_ = l
	if m.Props != nil {
		l = m.Props.Size()
...
func (this *ProcessorCoreUnion) SetValue(value interface{}) bool {
	...
	case *PropValidatorSpec:
		this.PropValidator = vt
	default:
		return false
	}
	return true
...
func (m *ProcessorCoreUnion) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 27:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PropValidator", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.PropValidator == nil {
				m.PropValidator = &PropValidatorSpec{}
			}
			if err := m.PropValidator.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
	...
	for iNdEx < l {
		...
		case 1:
			if wireType == 0 {
				...
				m.NotNullCols = append(m.NotNullCols, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field NotNullCols", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipProcessors(dAtA[iNdEx:])
...
func (m *PropValidatorSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PropValidatorSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PropValidatorSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorProcessors = []byte{
	...
	,
}
