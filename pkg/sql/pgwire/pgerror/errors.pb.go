...
// for a list of all Postgres error severities.
type Severity int32

const (
	Severity_UNKNOWN Severity = 0
	Severity_DEBUG   Severity = 1
	Severity_LOG     Severity = 2
	Severity_INFO    Severity = 3
	Severity_NOTICE  Severity = 4
	Severity_WARNING Severity = 5
	Severity_ERROR   Severity = 6
	Severity_FATAL   Severity = 7
	Severity_PANIC   Severity = 8
)
...
func (Severity) EnumDescriptor() ([]byte, []int) { return fileDescriptorErrors, []int{0} }
...
type Error struct {
	...
	Severity        Severity `protobuf:"varint,7,opt,name=severity,proto3,enum=cockroach.pgerror.Severity" json:"severity,omitempty"`
}
...
func init() {
	...
	proto.RegisterEnum("cockroach.pgerror.Severity", Severity_name, Severity_value)
}
...
func (m *Error) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Severity != 0 {
		dAtA[i] = 0x38
		i++
		i = encodeVarintErrors(dAtA, i, uint64(m.Severity))
	}
	return i, nil
}
...
func (m *Error) Size() (n int) {
	...
	if m.Severity != 0 {
		n += 1 + sovErrors(uint64(m.Severity))
	}
	return n
}
...
var fileDescriptorErrors = []byte{
	...
	,
}
